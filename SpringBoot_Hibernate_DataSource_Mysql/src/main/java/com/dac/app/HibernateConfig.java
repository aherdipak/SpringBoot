...
@Configuration
// to scan all packages from application to create objects
@ComponentScan(basePackages = "com.dac.*")
...
public class HibernateConfig {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { env.getProperty("packagesToScan") });
